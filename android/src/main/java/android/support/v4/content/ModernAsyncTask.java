...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00171();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00182();

    static final class C00171 implements ThreadFactory {
    ...
    class C00182 extends WorkerRunnable<Params, Result> {
        C00182() {
            super();
        }
