...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(size2 - paddingTop, Integer.MIN_VALUE);
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        count = MeasureSpec.makeMeasureSpec((int) (((float) ((count - paddingLeft) - paddingRight)) * 0.8f), Integer.MIN_VALUE);
        paddingLeft = MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, Integer.MIN_VALUE);
        this.mPrevText.measure(count, paddingLeft);
        this.mCurrText.measure(count, paddingLeft);
        this.mNextText.measure(count, paddingLeft);
