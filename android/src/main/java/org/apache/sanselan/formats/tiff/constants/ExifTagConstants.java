...
public interface ExifTagConstants extends TiffDirectoryConstants, TiffFieldTypeConstants {
    ...
    public static final int f361xbb3b19bd = 3;
    ...
    public static final TagInfo EXIF_TAG_COLOR_MAP = new TagInfo("Color Map", (int) ThumbnailUtils.TARGET_SIZE_MINI_THUMBNAIL, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
    ...
    public static final TagInfo EXIF_TAG_JPG_FROM_RAW_START_IFD2 = new Offset("Jpg From Raw Start", 513, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_IFD2);
    public static final TagInfo EXIF_TAG_JPG_FROM_RAW_START_SUB_IFD = new Offset("Jpg From Raw Start", 513, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_SUB_IFD);
    public static final TagInfo EXIF_TAG_JPG_FROM_RAW_START_SUB_IFD2 = new Offset("Jpg From Raw Start", 273, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_SUB_IFD2);
    ...
    public static final TagInfo EXIF_TAG_PREVIEW_IMAGE_START_IFD0 = new Offset("Preview Image Start", 273, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_IFD0);
    ...
    public static final TagInfo EXIF_TAG_PREVIEW_IMAGE_START_SUB_IFD1 = new Offset("Preview Image Start", 273, FIELD_TYPE_LONG, 1, EXIF_DIRECTORY_SUB_IFD1);
    ...
    public static final TagInfo EXIF_TAG_RELATED_IMAGE_WIDTH = new TagInfo("Related Image Width", (int) FragmentTransaction.TRANSIT_FRAGMENT_OPEN, FIELD_TYPE_SHORT, 1, EXIF_DIRECTORY_INTEROP_IFD);
    ...
    public static final TagInfo EXIF_TAG_TILE_BYTE_COUNTS = new TagInfo("Tile Byte Counts", (int) PullToRefreshBase.SMOOTH_SCROLL_LONG_DURATION_MS, FIELD_TYPE_DESCRIPTION_UNKNOWN, 1, EXIF_DIRECTORY_UNKNOWN);
    ...
    public static final int f362xbc499e7a = 3;
    ...
    public static final int f363x58f722f4 = 3;
    ...
    public static final int f364xd650be17 = 7;
