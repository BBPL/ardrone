...
public interface C0257l extends IInterface {

    public static abstract class C0258a extends Binder implements C0257l {

        private static class C0319a implements C0257l {
        ...
        public static C0257l m1255I(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0257l)) ? new C0319a(iBinder) : (C0257l) queryLocalInterface;
        }
