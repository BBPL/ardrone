...
public interface C0355f extends IInterface {

    public static abstract class C0357a extends Binder implements C0355f {

        private static class C0356a implements C0355f {
            ...
            public boolean mo1209a(C0355f c0355f) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    obtain.writeStrongBinder(c0355f != null ? c0355f.asBinder() : null);
                    this.f123a.transact(8, obtain, obtain2, 0);
            ...
            public int hashCodeRemote() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    this.f123a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
        ...
        public static C0355f m1393T(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0355f)) ? new C0356a(iBinder) : (C0355f) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 8:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    isVisible = mo1209a(C0357a.m1393T(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    if (isVisible) {
                        i3 = 1;
                    }
    ...
    boolean mo1209a(C0355f c0355f) throws RemoteException;
