...
public interface be extends IInterface {
    ...
    public static abstract class C0156a extends Binder implements be {

        private static class C0155a implements be {
            ...
            public void onAddGeofencesResult(int i, String[] strArr) throws RemoteException {
                ...
                try {
                    ...
                    this.f64a.transact(1, obtain, obtain2, 0);
            ...
            public void onRemoveGeofencesByPendingIntentResult(int i, PendingIntent pendingIntent) throws RemoteException {
                ...
                try {
                    ...
                    this.f64a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static be m762q(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof be)) ? new C0155a(iBinder) : (be) queryLocalInterface;
        }
