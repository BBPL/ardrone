...
public interface C0260n extends IInterface {

    public static abstract class C0261a extends Binder implements C0260n {

        private static class C0321a implements C0260n {
        ...
        public static C0260n m1256L(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0260n)) ? new C0321a(iBinder) : (C0260n) queryLocalInterface;
        }
