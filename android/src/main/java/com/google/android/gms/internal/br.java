...
public interface br extends IInterface {
    ...
    public static abstract class C0180a extends Binder implements br {

        private static class C0179a implements br {
            ...
            public void cancelClick() throws RemoteException {
                ...
                try {
                    ...
                    this.f72a.transact(2, obtain, obtain2, 0);
            ...
            public void reinitialize() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.plus.internal.IPlusOneDelegate");
                    this.f72a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static br aa(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof br)) ? new C0179a(iBinder) : (br) queryLocalInterface;
        }
