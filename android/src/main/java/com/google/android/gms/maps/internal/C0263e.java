...
public interface C0263e extends IInterface {

    public static abstract class C0264a extends Binder implements C0263e {

        private static class C0310a implements C0263e {
        ...
        public static C0263e m1257B(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnCameraChangeListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0263e)) ? new C0310a(iBinder) : (C0263e) queryLocalInterface;
        }
