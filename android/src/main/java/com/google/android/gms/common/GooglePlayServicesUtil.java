...
import com.google.android.gms.internal.C0220i;
import com.google.android.gms.internal.C0230m;
...
public final class GooglePlayServicesUtil {
    ...
    public static Intent m18a(Context context, int i, int i2) {
        switch (i) {
            case 1:
            case 2:
                return m24b(i2) ? m27c(context) ? C0230m.m1161l(GOOGLE_PLAY_SERVICES_PACKAGE) : C0230m.m1160k("com.google.android.apps.bazaar") : C0230m.m1160k(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
                return C0230m.m1158i(GOOGLE_PLAY_SERVICES_PACKAGE);
            default:
                return null;
        }
    }

    public static String m19a(Context context, int i) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                return resources.getString(C0041R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0041R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0041R.string.common_google_play_services_enable_button);
            default:
                return resources.getString(17039370);
        }
    }

    public static boolean m20a(Resources resources) {
        return (as.an() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m25b(resources);
    }

    private static byte[] m21a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    private static byte[][] m22a(byte[][]... bArr) {
        int i;
        int i2 = 0;
        for (byte[][] length : bArr) {
            i2 += length.length;
        }
        byte[][] length2 = new byte[i2][];
    ...
    public static String m23b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        String string;
        switch (i) {
            case 1:
                string = m20a(context.getResources()) ? resources.getString(C0041R.string.common_google_play_services_install_text_tablet) : resources.getString(C0041R.string.common_google_play_services_install_text_phone);
                return m24b(i2) ? string + " (via Bazaar)" : string;
            case 2:
                string = resources.getString(C0041R.string.common_google_play_services_update_text);
                return m24b(i2) ? string + " (via Bazaar)" : string;
            case 3:
                return resources.getString(C0041R.string.common_google_play_services_enable_text);
            case 5:
                return resources.getString(C0041R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0041R.string.common_google_play_services_network_error_text);
            case 9:
                return resources.getString(C0041R.string.common_google_play_services_unsupported_text);
            default:
                return resources.getString(C0041R.string.common_google_play_services_unknown_issue);
        }
    }

    static boolean m24b(int i) {
        switch (m26c(i)) {
            case 0:
                if (m29g()) {
                    return false;
    ...
    private static boolean m25b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return as.ap() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    private static int m26c(int i) {
        return i == -1 ? 2 : i;
    }

    private static boolean m27c(Context context) {
        if (f31J) {
            return f33L;
        }
        try {
            return m21a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f30I) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }

    private static byte[] m28c(String str) {
        try {
    ...
    public static boolean m29g() {
        return f31J ? f32K : "user".equals(Build.TYPE);
    }

    public static Dialog getErrorDialog(int i, Activity activity, int i2) {
        return m17a(i, activity, i2, null, -1);
    }

    public static Dialog getErrorDialog(int i, Activity activity, int i2, OnCancelListener onCancelListener) {
        return m17a(i, activity, i2, onCancelListener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int i, Context context, int i2) {
        Intent a = m18a(context, i, -1);
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0041R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
            Log.e("GooglePlayServicesUtil", "The Google Play services resources were not found. Check your project configuration to ensure that the resources are included.");
        }
        try {
            if (m21a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), f24C) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                return 9;
            }
            try {
                PackageInfo packageInfo = packageManager.getPackageInfo(GOOGLE_PLAY_SERVICES_PACKAGE, 64);
                if (m21a(packageInfo, r4) == null) {
