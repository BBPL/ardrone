...
public final class C0443x {
    public static Map<String, String> m1729a(Locale locale) {
        ...
        C0443x.m1730a(hashMap, locale.getLanguage());
        C0443x.m1730a(hashMap, locale.getLanguage() + "_" + locale.getCountry());
        return hashMap;
    }

    private static void m1730a(Map<String, String> map, String str) {
        if ("af".equals(str)) {
