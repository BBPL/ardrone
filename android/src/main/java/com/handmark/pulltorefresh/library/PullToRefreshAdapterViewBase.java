...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements OnScrollListener {
    ...
    private void addIndicatorViews() {
        ...
        if (mode.showHeaderLoadingLayout() && this.mIndicatorIvTop == null) {
            ...
            layoutParams.rightMargin = getResources().getDimensionPixelSize(C0976R.dimen.indicator_right_padding);
        ...
        if (mode.showFooterLoadingLayout() && this.mIndicatorIvBottom == null) {
            ...
            layoutParams2.rightMargin = getResources().getDimensionPixelSize(C0976R.dimen.indicator_right_padding);
    ...
    protected void handleStyledAttributes(TypedArray typedArray) {
        this.mShowIndicator = typedArray.getBoolean(C0976R.styleable.PullToRefresh_ptrShowIndicator, !isPullToRefreshOverScrollEnabled());
    }
