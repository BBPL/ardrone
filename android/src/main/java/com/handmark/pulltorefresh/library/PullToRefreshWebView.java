...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
    private static final OnRefreshListener<WebView> defaultOnRefreshListener = new C09741();
    private final WebChromeClient defaultWebChromeClient = new C09752();

    static final class C09741 implements OnRefreshListener<WebView> {
        C09741() {
        }
    ...
    class C09752 extends WebChromeClient {
        C09752() {
        }
    ...
    protected WebView createRefreshableView(Context context, AttributeSet attributeSet) {
        ...
        internalWebViewSDK9.setId(C0976R.id.webview);
