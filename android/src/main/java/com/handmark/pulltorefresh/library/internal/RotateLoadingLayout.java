...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    public RotateLoadingLayout(Context context, Mode mode, Orientation orientation, TypedArray typedArray) {
        ...
        this.mRotateDrawableWhilePulling = typedArray.getBoolean(C0976R.styleable.PullToRefresh_ptrRotateDrawableWhilePulling, true);
    ...
    protected int getDefaultDrawableResId() {
        return C0976R.drawable.default_ptr_rotate;
    }
